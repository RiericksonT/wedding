...
const svgToCategoryMap: Record<string, string> = {
  ...
  KitchenUtensils: "utensílios-cozinha",
  Table: "mesa-jantar",
  Microwave: "micro-ondas",
  Sink: "pia",
  Cooktop: "cooktop",
  RangeHood: "coifa",
  KitchenCabinets: "armários-cozinha",
};
...
export default function KitchenSVG() {
  ...
  const getCategoryDescription = (category: string): string => {
    const descriptions: Record<string, string> = {
      "freezer": "Para conservar alimentos congelados",
      "eletrodomésticos": "Equipamentos para nossa cozinha",
      "utensílios-cozinha": "Panelas, talheres e acessórios",
      "mesa-jantar": "Para nossas refeições em família",
      "micro-ondas": "Para aquecer e preparar refeições",
      "pia": "Para lavar louças e alimentos",
      "cooktop": "Para preparar nossas refeições",
      "coifa": "Para ventilação e exaustão",
      "armários-cozinha": "Para organizar nossa cozinha",
    };
    
    return descriptions[category.toLowerCase()] || "Item especial para nossa cozinha";
  };
  ...
  const getFallbackData = (): Record<string, FurnitureData> => {
    return {
      Freezer: {
        name: "Freezer",
        description: "Para conservar alimentos congelados",
        options: [
          {
            id: "freezer-1",
            name: "Freezer Vertical Frost Free",
            description: "Freezer moderno com tecnologia frost free",
            estimatedValue: 1899.90,
            image: "https://images.unsplash.com/photo-1584208124888-2ce080ab09e0",
      ...
      Cooktop: {
        name: "Cooktop",
        description: "Para preparar nossas refeições",
        options: [
          {
            id: "cooktop-1",
            name: "Cooktop 5 Bocas Vidro Temperado",
            description: "Cooktop moderno com acendimento automático",
  ...
  const handleMouseOver = (e: React.MouseEvent, itemId: string) => {
    if (!itemId || itemId === "Else" || itemId === "Kitchen") return;
    ...
    <div className="relative">
      ...
      <div className="relative w-full flex justify-center mb-8">
        <div className="relative w-full max-w-3xl">
          <Kitchen
            className="w-full h-auto kitchen-svg"
